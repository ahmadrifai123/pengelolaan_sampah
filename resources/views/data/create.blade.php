...
<form role="form" id="form" enctype="multipart/form-data" method="POST" action="{{route('me.store')}}">
            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="name" placeholder="Enter email" name="Masukan Gmail" name="email">
                </div>
                <div class="form-group">
