			...
			<div class="col-xs-12">
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Data Tempat Pembuangan Pertama</h3>
						<div class="box-tools pull-right">
							<a href="{{ route('tpp.create')}}" class="btn btn-primary btn-sm btn-flat">
